...
function ProductsGrid({products}:{products:Product[]}) {
  return  <div className="pt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-3 overflow-hidden">
                           ...
                           <Card className="transform group-hover:shadow-xl transition-shadow duration-500 overflow-hidden">
                                <CardContent className="p-4">
                                  <div className="relative h-80 md:h-80 rounded overflow-hidden">
                                     <Image src={image} alt={name} fill sizes='(max-width:768px) 100vw, (max-width:1200px) 5ovw, 33vw' priority
